                  ...
                  {row.map((square, colIndex) => {
                    ...
                    return (
                      <div
                        ...
                        key={colIndex}
                        className={`flex 
                                        ${isLegalMove ? (doesPieceExist ? "bg-red-400" : "bg-blue-400 border-black border-1") : (rowIndex + colIndex) % 2 === 0 ? "bg-yellow-100" : "bg-green-800"}  
                                        justify-center items-center w-9 h-9 sm:w-14 sm:h-14 lg:w-16 lg:h-16
                                        `}
                      >
                        <div className={`select-none ${selectedSquare && selectedSquare[0] === rowIndex && selectedSquare[1] === colIndex ? "bg-purple-300" : ""} `}>
                          {" "}
                          {square?.type ? (
                            <img
